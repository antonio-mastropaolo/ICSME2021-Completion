...
class Comment():
  ...
  def __init__(self, text, line_number, starting_index, ending_index, multiline=False):
    """Initializes Comment.
  ...
  def __repr__(self):
    return 'Comment(%s, %d, [%d-%d], %s)' % (self._text, self._line_number, self._starting_index, self._ending_index, self._multiline)
